...
namespace Minesweeper
{
    public partial class Minesweeper : Form
    {
        ...
        {
            lblMinesLeft.Text = $"Мин осталось: {_board.NumMinesRemaining}";
        }
        ...
        {
            var response = MessageBox.Show("Ты хочешь выйти из игры?", "Выйти из игры?", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        ...
        {
            var response = MessageBox.Show("Хочешь начать новую игру?", "Начать новую игру", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
